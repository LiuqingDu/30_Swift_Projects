...
//  12_Sportlight_Search
//
//  Created by Liuqing Du on 12/02/2018.
...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let searchItem = CSSearchableItem(uniqueIdentifier: "\(indexPath.row)", domainIdentifier: "duliuqing", attributeSet: attributSet)
